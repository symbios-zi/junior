			...
			<div class="add-wrapper">
				<div class="row"><div class="col-lg-12"> 
					...
					<div class="row">
						...
						<div class="col-lg-1" id="add-title-help"></div>
					</div>
						...
						<div class="row" style="margin-top: 20px;">
							...
							<div class="col-lg-1 col-md-1 col-sm-1 col-xs-2 add-date-from-wrap" >
								<div class="add-category-wrap">
									<input type="text" form="add-form" name="date_start" form="add-form" value="<?php echo $date_start; ?>"
								...
								<div class="pull-right">
									<label class="add-category"><span class="add-date-always">Постоянно</span>
										<label style="margin-bottom: 0;">
											<input class="add-checkbox" id="checkbox-daily" type="checkbox" form="add-form"
						...
						<div class="row add-vk-id hidden">
							<div class="col-xs-6 col-sm-2 col-sm-offset-3 col-lg-2 col-lg-offset-3 add-vk-inp">
								...
								placeholder="<?php if(array_key_exists('vk_id', $errors)){ echo 'vk.com/ваш id';} else echo 'https://vk.com/id...'?>" value="<?php echo $vkid; ?>">
							</div>
