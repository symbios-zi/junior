...
class Pagination{
	...
	// #var Ссылок навигации на странице
	private $max = 10;
    ...
    // #var Текущая страница (STATIC)
    private static $this_page;

	// #var Общее количество записей
	private $total;

	// #var Записей на странице
    ...
    private function generateHtml($page, $text = null)
    {
        ...
        if ($this->index == 'page-'){
            ...
            $currentURI = rtrim($_SERVER['REQUEST_URI'], '/');
            if (self::$this_page > 1){
                $currentNum = strrpos($currentURI, '&');
                if ($currentNum){
                $currentURI = substr($currentURI, 0, $currentNum);
                }
            }
        }
